namespace PushSharp.Windows
{
    ...
    public class WnsServiceConnection : IServiceConnection<WnsNotification>
    {
        ...
        public WnsAccessTokenManager AccessTokenManager { get; }
        ...
        public async Task Send(WnsNotification notification)
        {
            ...
            using (var http = new HttpClient())
            {
                ...
                if (notification.TimeToLive.HasValue)
                {
                    ...
                    http.DefaultRequestHeaders.TryAddWithoutValidation("X-WNS-TTL", notification.TimeToLive.Value.ToString());
                }
                ...
                if (notification.Type == WnsNotificationType.Tile)
                {
                    ...
                    {
                        // TILE only
                        http.DefaultRequestHeaders.Add("X-WNS-Tag", winTileNot.NotificationTag);
                    }
                }
        ...
        private WnsNotificationStatus ParseStatus(HttpResponseMessage resp, WnsNotification notification)
        {
        ...
        private string TryGetHeaderValue(HttpResponseHeaders headers, string headerName)
        {
